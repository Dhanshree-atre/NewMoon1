...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      increment: (...args_1) => {
        ...
        const amount_to_add_0 = args_1[1];
        ...
        if (!(typeof(amount_to_add_0) === 'bigint' && amount_to_add_0 >= 0n && amount_to_add_0 <= 4294967295n)) {
          __compactRuntime.type_error('increment',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(amount_to_add_0),
  ...
  _increment_0(context, partialProofData, amount_to_add_0) {
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('counter.compact line 17 char 15: cast from unsigned value to smaller unsigned value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
